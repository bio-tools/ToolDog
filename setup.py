...
setup(name="tooldog",
        ...
        install_requires=['requests', 'galaxyxml>=0.2.3', 'pycwl>=0.1.1'],
        dependency_links = ['https://github.com/erasche/galaxyxml/archive/master.zip#egg=galaxyxml-0.2.3.1', 'https://github.com/khillion/pycwl/archive/master.zip#egg=pycwl-0.1.1'],
        packages=["tooldog"],
